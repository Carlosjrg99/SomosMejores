              ...
              <tbody>
                    <%
                        ...
                        for (Docente docente : DocenteDAO.obtenerDatos()) {
                            ...
                            out.println("<td><a href='Eliminar.jsp?rut=" + docente.getRut() + "'>eliminar</a></td>");
                            out.println("<td><a href='Modificar.jsp?rut=" + docente.getRut() + "'>modificar</a></td>");
                            out.println("</tr>");
                        }
                    %>
                    </tbody>
