...
<html>
    ...
    <body>
        ...
        <%
                ...
                if(estadoSesion == null )
                {
                    ...
                    // tiene nivel de acceso?
                     if(user.getTipoUsuario() !=1)  // 1 administrador
                     {                         
        ...
        <ul id="dropdown1" class="dropdown-content">
            ...
            <li><a href="ReporteDocentes.jsp">Docentes</a></li>
            <li><a href="ReporteNoSalida.jsp">No Salidas</a></li>
            <li class="divider"></li>
            <li><a href="CerrarSesion.jsp">Salir</a></li>
        </ul>
        <nav>
            <div class="nav-wrapper">
                <a href="#!" class="brand-logo">Menú Administrador</a>
                <ul class="right hide-on-med-and-down">
                    <li><a href="asistencia.jsp">Ingresas Asistencia</a></li>
                    <li><a href="CRUD_Docentes.jsp">CRUD Docentes</a></li>
                    <!-- Dropdown Trigger -->
